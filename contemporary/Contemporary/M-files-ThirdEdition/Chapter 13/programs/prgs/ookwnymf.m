function [ret,x0,str,ts,xts]=ookwnymf(t,x,u,flag);
%OOKWNYMF	is the M-file description of the SIMULINK system named OOKWNYMF.
%	The block-diagram can be displayed by typing: OOKWNYMF.
%
%	SYS=OOKWNYMF(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes OOKWNYMF to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling OOKWNYMF with a FLAG of zero:
%	[SIZES]=OOKWNYMF([],[],[],0),  returns a vector, SIZES, which
...
set_param([sys,'/',['Wurzel-Nyquist',13,'Filter']],...
		'Mask Entries','1\/.05\/0.5\/6\/''FIR/Sqrt''\/0\/')


%     Finished composite block ['Wurzel-Nyquist',13,'Filter'].

set_param([sys,'/',['Wurzel-Nyquist',13,'Filter']],...
		'position',[725,98,805,142])
...
set_param([sys,'/','Wurzel-Nyquist'],...
		'Mask Help','This block designs a raised cosine filter using the specified parameter. The filter is used to filter the input signal. You can optionally use the sinc filter in the filtering computation.')
set_param([sys,'/','Wurzel-Nyquist'],...
		'Mask Entries','1\/.05\/0.5\/6\/''FIR/Sqrt''\/1\/')


%     Finished composite block 'Wurzel-Nyquist'.

set_param([sys,'/','Wurzel-Nyquist'],...
		'position',[70,98,150,142])

add_block('built-in/Gain',[sys,'/','Gain'])
set_param([sys,'/','Gain'],...
		'hide name',0,...
		'Gain','4',...
		'position',[170,107,195,133])
...
add_line([sys,'/','Quelle'],[145,85;225,85])


%     Finished composite block 'Quelle'.

set_param([sys,'/','Quelle'],...
		'position',[10,93,40,147])
...
add_line(sys,[240,150;255,150])
add_line(sys,[635,35;645,115])
add_line(sys,[520,35;530,35])
add_line(sys,[855,120;895,120])
add_line(sys,[935,120;995,120])
add_line(sys,[360,150;370,150;370,130;390,130])
add_line(sys,[430,125;490,125])
add_line(sys,[580,125;645,125])
add_line(sys,[45,120;65,120])
add_line(sys,[200,120;390,120])
add_line(sys,[685,120;720,120])
add_line(sys,[155,120;165,120])
add_line(sys,[810,120;820,120])
add_line(sys,[960,120;960,225])
add_line(sys,[55,120;55,250;885,250;885,215;920,225])
add_line(sys,[55,220;75,220])
add_line(sys,[210,120;210,30;240,30])
add_line(sys,[210,120;210,200])
add_line(sys,[440,125;440,180])
add_line(sys,[600,125;600,200])
add_line(sys,[705,120;705,170])
add_line(sys,[865,120;865,30;890,30])
add_line(sys,[865,120;865,170])
