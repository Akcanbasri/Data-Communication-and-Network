function [ret,x0,str,ts,xts]=asknyqmf(t,x,u,flag);
%ASKNYQMF	is the M-file description of the SIMULINK system named ASKNYQMF.
%	The block-diagram can be displayed by typing: ASKNYQMF.
%
%	SYS=ASKNYQMF(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes ASKNYQMF to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling ASKNYQMF with a FLAG of zero:
%	[SIZES]=ASKNYQMF([],[],[],0),  returns a vector, SIZES, which
...
add_line(sys,[270,230;280,230])
add_line(sys,[410,135;475,135])
add_line(sys,[955,130;990,130])
add_line(sys,[360,230;360,140;375,140])
...
add_line(sys,[300,125;375,125])
add_line(sys,[325,125;325,165])
add_line(sys,[690,130;695,130])
add_line(sys,[785,130;790,130])
add_line(sys,[325,125;325,30;340,30])
