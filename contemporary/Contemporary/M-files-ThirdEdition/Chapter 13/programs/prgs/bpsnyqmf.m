function [ret,x0,str,ts,xts]=bpsnyqmf(t,x,u,flag);
%BPSNYQMF	is the M-file description of the SIMULINK system named BPSNYQMF.
%	The block-diagram can be displayed by typing: BPSNYQMF.
%
%	SYS=BPSNYQMF(T,X,U,FLAG) returns depending on FLAG certain
%	system values given time point, T, current state vector, X,
%	and input vector, U.
%	FLAG is used to indicate the type of output to be returned in SYS.
%
%	Setting FLAG=1 causes BPSNYQMF to return state derivatives, FLAG=2
%	discrete states, FLAG=3 system outputs and FLAG=4 next sample
%	time. For more information and other options see SFUNC.
%
%	Calling BPSNYQMF with a FLAG of zero:
%	[SIZES]=BPSNYQMF([],[],[],0),  returns a vector, SIZES, which
...
simver(1.3)
if (0 == (nargin + nargout))
     set_param(sys,'Location',[190,42,1255,319])
     open_system(sys)
end;
...
add_line(sys,[260,155;270,155])
add_line(sys,[625,35;635,115])
add_line(sys,[510,35;520,35])
add_line(sys,[925,120;985,120])
add_line(sys,[375,155;380,155;380,130;395,130])
add_line(sys,[435,125;500,125])
add_line(sys,[590,125;635,125])
add_line(sys,[45,120;80,120])
add_line(sys,[170,120;395,120])
add_line(sys,[675,120;705,120])
add_line(sys,[795,120;800,120])
add_line(sys,[835,120;885,120])
add_line(sys,[190,120;190,35;215,35])
add_line(sys,[190,120;190,190])
add_line(sys,[460,125;460,170])
add_line(sys,[600,125;600,205])
add_line(sys,[690,120;690,170])
add_line(sys,[850,120;850,175])
add_line(sys,[850,120;850,30;870,30])
add_line(sys,[950,120;950,225])
add_line(sys,[60,120;60,260;875,260;875,215;910,225])
add_line(sys,[60,220;75,220])
